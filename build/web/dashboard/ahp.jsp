<%-- 
    Document   : ahp
    Created on : May 23, 2023, 11:37:24 PM
    Author     : MAJORINFO
--%>
...
<html lang="en">
    ...
    <body data-sidebar="brand">
                    ...
                    <div class="container-fluid">
                        <div class="col-lg-12">
                            <div class="text-center py-3">
                                <h4 class="fw-semibold">Les critères de choix</h4>
                                <p class="text-muted">Parmi ces critères, choisissez celui qui vous intéressepuis cliquez sur le bouton Ajouter ci-dessous.
                                    Chaque option doit figurer sur une ligne distincte</p>
                            </div>
                            <div class="card">
                                <div class="card-body">
                                    <div class="col-lg-8 mx-auto">
                                        <div class="row" style="row-gap: 1rem;">
                                            <div class="tile col-lg-4 col-md-6 col-12">
                                                <input type="checkbox" class="check_box_item" data-value="Security" name="security" id="security">
                                                <label for="security" class="position-absolute">
                                                    <lottie-player src="/dashboard/assets/animation/security-shield.json" class="position-absolute"  background="transparent"  speed="1"  style="width: 200px; height: 200px;"  loop autoplay></lottie-player>
                                                    <h6 class="badge bg-danger" style="position: absolute;top: -1rem; right:1rem;">Security</h6>
                                                </label>
                                            </div>

                                            <div class="tile col-lg-4 col-md-6 col-12">

                                                <input type="checkbox" class="check_box_item" data-value="Price" name="price" id="price">
                                                <label for="price" class="position-absolute">
                                                    <lottie-player src="/dashboard/assets/animation/money-through.json"   background="transparent"  speed="1"  style="width: 200px; height: 200px;"  loop autoplay></lottie-player>
                                                    <h6 class="badge bg-danger" style="position: absolute;top: -1rem; right:1rem;">Price</h6>
                                                </label>
                                            </div>

                                            <div class="tile col-lg-4 col-md-6 col-12">
                                                <input type="checkbox" class="check_box_item" data-value="Flexibilité" name="flexibilite" id="flexibilite">
                                                <label for="flexibilite" class="position-absolute">
                                                    <lottie-player src="/dashboard/assets/animation/database-hub.json" class="position-absolute"  background="transparent"  speed="1"  style="width: 200px; height: 200px;"  loop autoplay></lottie-player>
                                                    <h6 class="badge bg-danger" style="position: absolute;top: -1rem; right:1rem;">Flexibilité</h6>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
        ...
        <script src="dashboard/assets/animation/lottie-player.js"></script>
        <script src="dashboard/assets/js/app.js"></script>
        
        <script>
            var selected_options = [];
            $('.check_box_item').on('change', function () {
                let selected_option = $(this).data('value');
                if (selected_options.indexOf(selected_option) === -1) {
                    selected_options.push(selected_option);
                } else {
                    selected_options.splice(selected_options.indexOf(selected_option), 1);
                }
                $('#selected_items').empty();

                selected_options.map((e) => {
                    $('#selected_items').append(
                      '<div class="my-3"><div class="card col-lg-8 mx-auto"><div class="card-body"><div class="d-flex justify-content-between align-items-center"><div><h5 class="text-uppercase">'+e+'</h5><p class="text-muted">lorem</p></div><div><select class="form-select" id="'+e+'_priority"><option>High priority</option><option>Medium priority</option><option>Low priority</option></select></div></div></div></div></div>'
                    );
                });
            });
        </script>
